...
import { setLoading, setQuery, setResults } from "@/lib/slices/search-slice";
      ...
      <div className="flex items-center gap-4">
        ...
        {pathname.startsWith("/search") && (
          <form onSubmit={handleSubmit} className="relative ">
            ...
            />
            <CiSearch className="absolute top-2 left-1" color="black" />
          </form>
        )}
      </div>
      <div className="flex items-center gap-5">
        {accessToken ? (
          ...
          <div className="flex gap-4">
            <button className="border px-5 py-1 rounded-lg">Sign up</button>
            <button
              onClick={handleLogin}
